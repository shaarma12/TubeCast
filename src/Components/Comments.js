      ...
      <div className="ml-3">
        <div className="flex text-sm">
          ...
          <p className="text-[#AAAAAA]">
            {commentPublishedDateModifier(publishedAt)}
          </p>
        </div>
        <p className="text-white w-[44rem]">
          {textOriginal.split("\n").map((line, index) => (
        ...
        <div className="flex mt-4">
          <div className="flex mr-3">
            <img
              src={likes}
              alt="likes"
              className="h-7 mr-1 hover:rounded-full hover:bg-[#AAAAAA] cursor-pointer"
            />
          ...
          <div className="flex">
            <img
              src={unlike}
              alt="unlike"
              className="h-7 ml-1 hover:rounded-full hover:bg-[#AAAAAA] cursor-pointer"
            />
          </div>
        </div>
      </div>
